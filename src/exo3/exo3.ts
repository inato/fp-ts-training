...
) => ReadonlyArray<string> = flow(readonlyArray.sort(string.Ord));

export const sortNumbers: (
  numbers: ReadonlyArray<number>,
) => ReadonlyArray<number> = flow(readonlyArray.sort(number.Ord));
...
export const sortNumbersDescending: (
  numbers: ReadonlyArray<number>,
) => ReadonlyArray<number> = flow(readonlyArray.sort(ord.reverse(number.Ord)));
...
) => ReadonlyArray<Option<number>> = flow(
...
) => ReadonlyArray<Person> = flow(readonlyArray.sort(byName));

export const sortPersonsByAge: (
  persons: ReadonlyArray<Person>,
) => ReadonlyArray<Person> = flow(readonlyArray.sort(byOptionalAge));
...
export const sortPersonsByAgeThenByName: (
  persons: ReadonlyArray<Person>,
) => ReadonlyArray<Person> = readonlyArray.sortBy([byOptionalAge, byName]);
