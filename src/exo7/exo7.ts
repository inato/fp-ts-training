...
//     number.Eq,
//     { concat: (a, b) => b },
//     readonlyArray.Foldable, // @Punie I'm not sure what this does.
//   ),
// );
...
console.log(pageViewsA);

// export const pageViewsA = [
//   ['home', 5],
//   ['about', 2],
//   ['blog', 7],
// ];
...
export const allPageViews: ReadonlyMap<string, Analytics> =
  // union 2 maps pageViewsA and pageViewsB, but sum if key conflict
  readonlyMap.union(string.Eq, {
    concat: (a: Analytics, b: Analytics) => ({
      page: a.page,
      views: a.views + b.views,
    }),
  })(pageViewsA)(pageViewsB);
...
export const intersectionPageViews: ReadonlyMap<string, Analytics> =
  readonlyMap.intersection(string.Eq, {
    concat: (a: Analytics, b: Analytics) => ({
      page: a.page,
      views: a.views + b.views,
    }),
